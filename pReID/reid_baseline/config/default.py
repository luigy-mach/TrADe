...
class DefaultConfig:
    ...
    def __init__(self):
        ...
        # data
        self.DATA_DIR               = "/home/luigy/luigy/datasets/REID/Market-1501-v15.09.15"  # dataset path
        ...
        # self.PRETRAIN_CHOICE = 'imagenet' #default
        self.PRETRAIN_CHOICE = 'resnet50_ibn_a'
        self.PRETRAIN_PATH   = "/home/luigy/luigy/develop/person-reid-tiny-baseline/weights/resnet50/resnet50_person_reid_128x64.pth"  # pretrained weight path
        ...
        self.QUERY_DIR          = '/home/luigy/luigy/datasets/REID/Market-1501-v15.09.15/query'
