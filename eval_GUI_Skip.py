		...
		for tVideoPath, _ in tauVideos:
			...
			for outcomePath, outcomesFile in dirs_outcomes:
				...
				for qPath, qFile in qFiles:
					...
					# print(outcomeImgsDir)
					imgsListPath        = find_files(outcomeImgsDir  , '*frame*id*bbox*.png', type='absolute')
